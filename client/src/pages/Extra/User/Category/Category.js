        ...
        <div className="fullbox_set_cat">
          <div className="cat_box_extra">
            ...
            <p className="cat_para">
              "Fully-equipped hotel gym: cardio machines, free weights, and yoga
              mats for your workout convenience and comfort"
            </p>
            <h3 className="cat_topic_price">$250 for one day</h3>
          </div>
          <div className="cat_box_extra">
            <img src={Pool} alt="gym" className="cat_img_extra" />
            <h3 className="cat_topic_extra">POOL</h3>
            <p className="cat_para">
              "Relax in our serene hotel swimming pool oasis, a tranquil retreat
              for ultimate refreshment and rejuvenation"
            </p>
            <h3 className="cat_topic_price">$2550 for one day</h3>
          </div>
          <div className="cat_box_extra">
            <img src={Bar} alt="gym" className="cat_img_extra" />
            <h3 className="cat_topic_extra">BAR SERVICES</h3>
            <p className="cat_para">
              "Sophisticated cocktails, cozy ambiance, live music—our hotel bar
              is the perfect spot to unwind and socialize."
            </p>
            <h3 className="cat_topic_price">$2570 for one day</h3>
          </div>
          <div className="cat_box_extra">
            ...
            <h3 className="cat_topic_price">$2540 for one day</h3>
          </div>
          <div className="cat_box_extra">
            <img src={Vehical} alt="gym" className="cat_img_extra" />
            <h3 className="cat_topic_extra">VEHICLE SERVICES</h3>
            <p className="cat_para">
              "Convenient hotel vehicle services for hassle-free transportation,
              ensuring comfort and ease for guests"
            </p>
            <h3 className="cat_topic_price">$2502 for one day</h3>
          </div>
          <div className="cat_box_extra">
            ...
            <h3 className="cat_topic_price">$2880 for one day</h3>
          </div>
          <div className="cat_box_extra">
            <img src={Specitiol} alt="gym" className="cat_img_extra" />
            <h3 className="cat_topic_extra">SPECIAL DAY ARRANGMENT</h3>
            <p className="cat_para">
              "Special day arrangements at the hotel: exquisite decor, culinary
              delights, and memorable experiences"
            </p>
            <h3 className="cat_topic_price">$290 for one day</h3>
          </div>
          <div className="cat_box_extra">
            ...
            <h3 className="cat_topic_price">$280 for one day</h3>
          </div>
        </div>
      </div>
      <button
