    ...
    <Document>
      {itemChunks.map((items, index) => (
        <Page key={index} size="A4" orientation="landscape" style={styles.page}>
          ...
          <Text style={styles.title}>Events Table</Text>
          ...
          <Text style={styles.tableHeader}>Capacity</Text>
              ...
              <Text style={styles.tableHeader}>Starting Time</Text>
            ...
            {items.map((item) => (
              <View key={item._id} style={styles.row}>
                ...
                <Text style={styles.cell}>{item.cap}</Text>   
                <Text style={styles.cell}>{item.date}</Text>   
                <Text style={styles.cell}>{item.etype}</Text>   
                <Text style={styles.cell}>{item.venue}</Text>   
                <Text style={styles.cell}>{item.sTime}</Text>   
                <Text style={styles.cell}>{item.eTime}</Text>   
